...
#The path of the file needs to be added in order to open it.
f = open("/Users/marianabaronifontana/Projects/replit-100-days-of-code/Day 55 - OS Library/ToDoList.txt", "r")
...
#Creates a backup of the list before saving it.
filename = os.path.join("/Users/marianabaronifontana/Projects/replit-100-days-of-code/Day 55 - OS Library", "ToDoListBackup.txt")
